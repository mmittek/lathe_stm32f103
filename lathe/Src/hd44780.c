...
#define LCD_RCC RCC_GPIOA
#define LCD_RS GPIO_PIN_0
#define LCD_CLOCK GPIO_PIN_1
#define LCD_4 GPIO_PIN_2
#define LCD_5 GPIO_PIN_3
#define LCD_6 GPIO_PIN_4
#define LCD_7 GPIO_PIN_5
...
static void _lcd_delay_ms(uint32_t delay)
{
    ...
    uint32_t cycles = (delay * 64000)/5;  // 8 Mhz, CMP+BEQ+NOP+ADDS+B
    uint32_t i = 0;
    while(i++ < cycles) {
        __asm__("nop");
    }
